...
class ChartViewModelFactory @Inject constructor(private val repository: MoexRepository,
                                                private val sPrefs: SharedPreferences,
                                                private val localRepository: LocalRepository): ViewModelProvider.Factory {
